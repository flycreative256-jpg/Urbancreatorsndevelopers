      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative">
          ...
          <motion.div 
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 glass-dark-liquid p-6 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/20 text-center min-w-[200px]"
          >
            <span className="block text-4xl font-heading font-bold text-white mb-1">15+</span>
            <span className="text-sm font-semibold text-secondary uppercase tracking-wider">Years of Trust</span>
          </motion.div>
        </div>

        {/* Content */}
        <div>
          <span className="text-secondary font-semibold tracking-wider uppercase text-sm">About Our Company</span>
          <h2 className="text-4xl md:text-5xl text-white mt-2 mb-6">Built by Engineers. Driven by Excellence.</h2>
