      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/" className="relative inline-block group p-4">
              ...
              <img 
                ...
                className="relative z-10 h-32 w-auto object-contain transition-transform duration-500 group-hover:scale-105" 
              />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="hover:text-secondary transition-colors cursor-pointer">Residential Construction</li>
              <li className="hover:text-secondary transition-colors cursor-pointer">Luxury Villas</li>
              <li className="hover:text-secondary transition-colors cursor-pointer">Commercial Spaces</li>
              <li className="hover:text-secondary transition-colors cursor-pointer">Turnkey Projects</li>
            </ul>
          </div>
